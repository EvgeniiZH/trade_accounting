# trade_accounting/settings/base.py
import os
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Добавьте этот middleware
...
# Настройки базы данных (будут переопределены в local.py/production.py)
DATABASES = {
    'default': {
